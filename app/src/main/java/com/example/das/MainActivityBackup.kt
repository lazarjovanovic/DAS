...
//
//
//class MainActivityBackup : AppCompatActivity(), SensorEventListener {
...
//                    pmsManager.requestPermissions(mKeySet, this@MainActivityBackup)
...
//                if(address.equals("B4:C2:6A:71:B1:D6")) { // garmin
...
//                //if(rez_device_str.equals("DB:97:6A:0A:DD:A0")) // amazfit bip u
//                //if(rez_device_str.equals("AC:E3:42:77:72:7D")) // honor magic watch 2
//                if(rez_device_str.equals("B4:C2:6A:71:B1:D6")) // garmin forerunner 245 music
//                {
//                    with(result.device){
//                        Log.w("ScanResultAdapter", "Connecting to $address")
